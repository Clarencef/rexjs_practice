...
/***/ function(module, exports, __webpack_require__) {
	...
	_Rx2.default.Observable.fromEvent((0, _jquery2.default)('#searchInput'), 'keyup').subscribe(function (e) {
		_Rx2.default.Observable.fromPromise(getData(e.target.value)).subscribe(function (x) {
			console.log(x);
