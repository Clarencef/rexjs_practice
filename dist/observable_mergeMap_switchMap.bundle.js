...
/***/ function(module, exports, __webpack_require__) {
	...
	_Rx2.default.Observable.of('Hello').subscribe(function (v) {
		_Rx2.default.Observable.of(v + ' World').subscribe(function (x) {
	...
	_Rx2.default.Observable.of('Hello').mergeMap(function (v) {
		return _Rx2.default.Observable.of(v + ' World');
	...
	var myId = (0, _jquery2.default)('#name');
	var myBlog = (0, _jquery2.default)('#blog');
	var myRepos = (0, _jquery2.default)('#repos');
	var inputSouce$ = _Rx2.default.Observable.fromEvent((0, _jquery2.default)('#searchInput'), 'keyup').map(function (e) {
		return e.target.value;
	}).switchMap(function (v) {
		return _Rx2.default.Observable.fromPromise(getData(v));
	});

	inputSouce$.subscribe(function (x) {
