...
/***/ function(module, exports, __webpack_require__) {
	...
	var numberArr = [3, 42, 1, 23, 9];

	var numberArr$ = _Rx2.default.Observable.from(numberArr);

	numberArr$.subscribe(function (v) {
		console.log(v);
	}, function (err) {
		console.log(err);
	}, function (complete) {
	...
	var post = [{ title: 'one', body: 'body one' }, { title: 'two', body: 'body two' }, { title: 'three', body: 'body three' }];

	var post$ = _Rx2.default.Observable.from(post);

	post$.subscribe(function (post) {
		console.log(post);
		(0, _jquery2.default)('#post-list').append('<li><h3>' + post.title + '</h3><p>' + post.body + '</p></li>');
	}, function (err) {
		console.log(err);
	}, function (complete) {
		console.log('completed');
	...
	var set = new Set(['Hello', 42, { title: 'the world' }]);
