...
/***/ function(module, exports, __webpack_require__) {
	...
	_Rx2.default.Observable.of('HELLO').merge(_Rx2.default.Observable.of('friends')).subscribe(function (x) {
							return console.log(x);
	});

	var mapSource1$ = _Rx2.default.Observable.interval(2000).map(function (v) {
							return 'Merge1: ' + v;
	});
	var mapSource2$ = _Rx2.default.Observable.interval(500).map(function (v) {
							return 'Merge2: ' + v;
	});
	_Rx2.default.Observable.merge(mapSource1$, mapSource2$).take(25).subscribe(function (x) {
							return console.log(x);
	});

	// concat 先跑完第一個source在執行第二個source要做的動作
	var concatSource1$ = _Rx2.default.Observable.range(0, 5).map(function (v) {
							return 'Source1: ' + v;
	});
	var concatSource2$ = _Rx2.default.Observable.range(6, 5).map(function (v) {
							return 'Source2: ' + v;
	});
	_Rx2.default.Observable.concat(concatSource1$, concatSource2$).subscribe(function (x) {
							return console.log(x);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var nextTick = __webpack_require__(290).nextTick;
