...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapSource$ = _Rx2.default.Observable.from(['John', 'Albert', 'Ben']).map(function (v) {
		return v.toUpperCase();
	}).map(function (v) {
		return 'I am ' + v;
	});

	mapSource$.subscribe(function (v) {
	...
	_Rx2.default.Observable.fromPromise(getData('Clarencef')).map(function (user) {
		return user.data;
	...
	// plunk
	var users = [{ name: 'Will', age: 40 }, { name: 'Mike', age: 45 }, { name: 'albert', age: 28 }];

	var plunkSource$ = _Rx2.default.Observable.from(users).pluck('name');
	plunkSource$.subscribe(function (x) {
